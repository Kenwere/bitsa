...
<head>
    ...
    <title>User Registration - Bitsa Club</title>
    ...
    <div class="register-container">
        <div class="register-card">
            <div class="register-header">
                ...
                <p>Join the Bitsa Club community today</p>
            </div>
            ...
            <form action="{{ route('user.register') }}" method="POST" id="registerForm">
                ...
                <div class="verification-section" id="verificationSection">
                    <h6 class="mb-3"><i class="bi bi-shield-check"></i> Email Verification</h6>
                    <div class="mb-3">
    ...
    <script>
        ...
        document.getElementById('registerForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                verificationMessage.textContent = `Verification code sent to ${email}`;

                // Change form submission to include verification
                submitText.textContent = 'Verify & Create Account';
