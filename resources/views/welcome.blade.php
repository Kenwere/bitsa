...
<body>
    ...
    <nav class="floating-nav">
        <a href="#user-login" class="nav-btn">User Login</a>
    ...
    <section class="section welcome-section">
        ...
        <div class="welcome-content">
            ...
            <div class="cta-buttons">
                <a href="#user-login" class="cta-btn cta-primary">Get Started</a>
                <a href="#admin-login" class="cta-btn cta-secondary">Admin Access</a>
            </div>
        </div>
    ...
    <!-- User Login -->
    <section class="section login-section" id="user-login">
        <!-- Matrix Rain for Login Section -->
        <div class="matrix-rain" id="userMatrixRain"></div>
        ...
        <div class="login-card">
            ...
            <form action="{{ route('user.login.submit') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="user-email" name="email" placeholder="Enter your email" value="{{ old('email') }}" required>
                </div>
                <div class="mb-3">
                    ...
                    <div class="password-input-group">
                        ...
                        <button type="button" class="password-toggle" id="toggleUserPassword">
                            <i class="bi bi-eye"></i>
                        </button>
                    </div>
                </div>
                ...
                <div class="register-link">
                    Need an account? <a href="{{ route('user.register') }}">Register here</a>
                </div>
            </form>
        </div>
    </section>
    ...
    <!-- Admin Login -->
    <section class="section login-section" id="admin-login">
        <!-- Matrix Rain for Login Section -->
        <div class="matrix-rain" id="adminMatrixRain"></div>
        
        <div class="login-card">
            <div class="login-header">
                <h2><i class="bi bi-shield-check"></i> Admin Login</h2>
            ...
            <form action="{{ route('admin.login.submit') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="admin-email" name="email" placeholder="Enter your email" value="{{ old('email') }}" required>
                </div>
                <div class="mb-3">
                ...
                <div class="register-link">
                    Need an account? <a href="{{ route('admin.register') }}">Register here</a>
                </div>
            </form>
        </div>
    </section>
    ...
    <script>
        ...
        // Create matrix rain for all sections
        createMatrixRain('matrixRain');
        createMatrixRain('userMatrixRain');
        createMatrixRain('adminMatrixRain');
        ...
        document.querySelectorAll('.nav-btn, .cta-btn').forEach(link => {
